...
public class WebdriverUtility {
	...
	public void switchToTabOnURL(WebDriver driver , String partialURL) {
	     ...
	     * 
	     */
	    public void toScrollIntoView(WebDriver driver,String eleAddress ) {
	    	JavascriptExecutor js = (JavascriptExecutor) driver;
			js.executeScript("arguments[0].scrollIntoView(true)", eleAddress);
			
	    }
	    
	    public void toScrollBy(WebDriver driver , String EL ) {
